...
let levels = JSON.parse(JSON.stringify(initialLevels)); // Kopia poziomów do edycji
...
function resetGame() {
    levels = JSON.parse(JSON.stringify(initialLevels)); // Przywrócenie poziomów do stanu początkowego
